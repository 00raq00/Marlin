...
#define CUSTOM_MACHINE_NAME "Artillery Hornet"   //3DPG
...
#define PIDTEMPBED    //3DPG
  ...
  #define DEFAULT_bedKp  92.75      //3DPG    Artillery Hornet
...
#define MAX_CHAMBER_POWER 255 // limits duty cycle to chamber heater; 255=full current
  ...
  #define PID_FUNCTIONAL_RANGE 15 // 3DPG If the temperature difference between the target temperature and the actual temperature
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.121, 80.121, 400, 410 }  //3DPG
 ...
 */
#define DEFAULT_ACCELERATION                   600  //3DPG X, Y, Z ... and E acceleration for printing moves
 ...
 */
#define S_CURVE_ACCELERATION    //3DPG
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -56, -1, -2 }
